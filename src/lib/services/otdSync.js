...
export function buildOtdPayload(quotation) {
  ...
  return {
    ...
    customer: {
      ...
      fullAddressWithGST: safeStr(customer.fullAddressGst),
      designation: safeStr(customer.designation),
      emailCC: safeStr(customer.emailCc),
      location: safeStr(customer.location),
      userID: safeStr(customer.userId),
      engineerRemark: safeStr(customer.engineerRemark),
      sourceOfEnquiry: safeStr(info.sourceOfEnquiry),
      enquiryGeneratedBy: safeStr(info.enquiryGeneratedBy),
      validity: safeStr(info.quotationValidity),
      quotationDate: safeStr(info.quotationDate),
      partyRefNo: safeStr(info.partyReferenceNumber),
      partyRefDt: safeStr(info.partyReferenceDate),
      quotationFollowupBy: safeStr(info.quotationFollowUpBy),
      nextFollowupDate: safeStr(followup.nextFollowupDate),
      nextFollowupStatus: safeStr(followup.nextFollowupStatus),
      numberOfFollowup: safeStr(followup.numberOfFollowup),
      orderFollowupSummary: safeStr(followup.orderFollowUpSummary),
      remarkForOrderReceived: safeStr(followup.remarkForOrderReceived),
      orderNumber: safeStr(followup.orderNumber),
    },
